if (window.self != window.top) {
  var x = (window.location != window.parent.location) ? document.referrer : document.location;
  var y = "https://www.3rbcafee.com/"; 
  if (x == y) {
    ...
    window.location.href = "https://www.3rbcafee.com/"; 
  }
}
